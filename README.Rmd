...
In theory we could parameterize the VRT creation, but that's lofty and this gets us heaps of leverage over raadtools itself, because currently raadtools augments data in R code only. It does this by 
